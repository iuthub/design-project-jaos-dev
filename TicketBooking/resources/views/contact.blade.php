        ...
        <div class="row">
            ...
            <div class="col-lg-6 contact_col">
                <div class="contact_contents">
                    ...
                    <div>
                        <p>+99 897 435 11 11</p>
                        <p>info.estore@gmail.com</p>
                    </div>
                    <div>
                        <p>info.estore_official@gmail.com</p>
                    </div>
                    <div>
                ...
                <div class="follow_us_contents">
                    ...
                    <ul class="social d-flex flex-row">
                        <li><a  style="background-color: #3a61c9"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li><a  style="background-color: #41a1f6"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                        <li><a  style="background-color: #fb4343"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                        <li><a  style="background-color: #8f6247"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
