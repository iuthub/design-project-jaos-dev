...
<html lang="en">
<head>
    <title>E-store - {{ config('app.name') }} </title>
    <meta charset="utf-8">
    ...
    <header class="header trans_300">
        ...
        <div class="top_nav">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="top_nav_left">Favourite brands and hottest trends</div>
                    </div>
                    ...
                    <div class="footer_social d-flex flex-row align-items-center justify-content-lg-end justify-content-center">
                        <ul>
                            ...
                            <li><a href="http://www.github.com/"><i class="fa fa-github"
                                                                             aria-hidden="true"></i></a></li>
                            <li><a href="http://www.gitlab.com/"><i class="fa fa-gitlab"
                                                                             aria-hidden="true"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer_nav_container">
                        <div class="cr">©2019 All Rights Reserved. This template is made with <i class="fa fa-heart-o"
                                                                                                 aria-hidden="true"></i>
                            by <a href="#">JAOS</a></div>
                    </div>
                </div>
            </div>
        </div>
